#!/usr/bin/env bash
# AGP Tracker v6 — cinematic 3D: bloom, spring physics, trails, nebula, GPU instancing
...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  footer{margin-top:28px;padding-top:14px;border-top:1px solid var(--line);color:var(--dim);font-size:10px;line-height:1.7}
...
<div class="wrap">
  <header>
    <div>
      ...
      <div class="sub">Independent analytics for Agent Grand Prix · not affiliated with Subzero Labs</div>
    </div>
    <div class="hd-r">
  ...
  <footer>
    Live via SSE · source: public AGP API · avatars: GitHub ·
    <a href="https://agp.onlatch.com" target="_blank" rel="noopener">agp.onlatch.com</a> ·
    <a href="https://onlatch.com" target="_blank" rel="noopener">onlatch.com</a><br>
